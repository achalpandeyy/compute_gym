...
nvcc_common="nvcc.exe -keep -lineinfo -I ../../../cccl/ -I ../../../cccl/libcudacxx/include -I ../../../cccl/cub -I ../../../cccl/thrust --use-local-env -std=c++17 --generate-code=arch=${virtual_arch},code=[${real_arch},${virtual_arch}] --diag-suppress 186 --ptxas-options=-v -Xcompiler \"$host_compile\""
